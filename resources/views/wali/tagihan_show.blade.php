            ...
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    @if ($siswa->foto == true)
                                        <td rowspan="8" width="100">
                                            <img src="{{ Storage::url($siswa->foto) }}" alt="" width="180px"
                                                class="rounded mb-3" class="align-top">
                                        </td>
                                    @elseif($siswa->foto == null && $siswa->jenis_kelamin == 'Perempuan')
                                        <td rowspan="8" width="100" class="align-top">
                                            <img src="{{ asset('storage/images/no-image-woman.png') }}" alt=""
                                                width="180px" class="rounded mb-3">
                                        </td>
                                    @elseif($siswa->foto == null && $siswa->jenis_kelamin == 'Laki-Laki')
                                        <td rowspan="8" width="100" class="align-top">
                                            <img src="{{ asset('storage/images/no-image-man.jpg') }}" alt=""
                                                width="180px" class="rounded mb-3">
                                        </td>
                                </tr>
                                @endif
                    ...
                    <div class="alert alert-secondary" role="alert">
                        ...
                        <p style="color: black">Pembayaran Otomatis menggunakan Pihak ketiga, anda akan dikenakan biaya
                            tambahan sebesar Rp. 2.000,00</p>
                    ...
                    <div class="alert alert-secondary" role="alert" style="color:black">
                        Pembayaran Bisa DI lakukan Dengan Cara Langsung Ke Operator Sekolah Atau Di transfer Melalui
                    ...
                    <ul>
                        <li> <a href="{{ route('panduan.pembayaran', 'atm') }}" target="blank">Lihat Cara Melakukan
                                Pembayaran Dengan Transfer Melalui ATM</a></li>
                        <li> <a href="{{ route('panduan.pembayaran', 'internet-banking') }}" target="blank">Lihat Cara
                                Melakukan Pembayaran Dengan Transfer Melalui Internet Banking</a></li>
                    </ul>
                    <div class="row">
