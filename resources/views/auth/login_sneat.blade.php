...
<body>
    <div class="login">
        <img src="{{ asset('storage/images/megatama-no-bg.png') }}" alt="login image" class="login__img" width="10px"
        ...
        <form action="{{ route('login') }}" class="login__form" method="POST">
            ...
            <div class="login__content">
                <div class="login__box">
                    ...
                    <div class="login__box-input">
                        <input type="email" required class="login__input"type="text" class="form-control"
            ...
            <div class="login__check">
                ...
                <a href="{{ route('password.request') }}" class="login__forgot" style="font-weight: bold">Lupa
                    Password?</a>
            </div>
